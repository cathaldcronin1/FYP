...
(function () {
    ...
    \*/
    paperproto.ellipse = function (x, y, rx, ry, id) {
        var out = R._engine.ellipse(this, x || 0, y || 0, rx || 0, ry || 0, id || "");
        this.__set__ && this.__set__.push(out);
        return out;
    };
    /*\
...
window.Raphael && window.Raphael.svg && function (R) {
    ...
    R._engine.ellipse = function (svg, x, y, rx, ry, id) {
        var el = $("ellipse");
        svg.canvas && svg.canvas.appendChild(el);
        var res = new Element(el, svg);
        res.attrs = {cx: x, cy: y, rx: rx, ry: ry, fill: "none", stroke: "#000", "node-id": id};
        res.type = "ellipse";
        $(el, res.attrs);
        return res;
    };
